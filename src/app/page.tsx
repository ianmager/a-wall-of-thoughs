            ...
            <div className="flex min-w-0 flex-1 flex-col gap-3">
              ...
              {sp.error === "auth" ? (
                <p
                  ...
                  role="alert"
                >
                  Something went wrong signing you in. Try again, and confirm Supabase redirect
                  URLs include this app&apos;s{" "}
                  <code className="font-mono text-xs">/auth/callback</code> URL.
                </p>
              ) : null}
            </div>
